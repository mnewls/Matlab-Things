...
n_sims = [1000,2000,3000,4000,5000,10000];
...
for S = size
    ...
    for i = 1:1:length(n_sims)
        ...
        cost(s_count) = C / n_sims(i);
        s_count = s_count +1;
    end
end

subplot(2,3,1)
plot(size, cost(1:9), 'b')
title('N sims = 1000')
subplot(2,3,2)
plot(size, cost(10:18), 'r')
title('N sims = 2000')
subplot(2,3,3)
plot(size, cost(19:27), 'k')
title('N sims = 3000')
subplot(2,3,4)
plot(size, cost(28:36), 'b')
title('N sims = 4000')
subplot(2,3,5)
plot(size, cost(37:45), 'r')
title('N sims = 5000')
subplot(2,3,6)
plot(size, cost(46:54), 'k')
title('N sims = 10000')